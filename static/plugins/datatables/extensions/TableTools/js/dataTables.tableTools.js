...
TableTools.BUTTONS = {
	...
	"csv": $.extend( {}, TableTools.buttonBase, {
		...
		"sButtonText": "<i class='fa fa-file-text-o'></i> 导出csv",
		"sFieldBoundary": '"',
		"sFieldSeperator": ",",
	...
	"xls": $.extend( {}, TableTools.buttonBase, {
		...
		"sButtonText": "<i class='fa fa-file-excel-o'></i> 导出Excel",
		"fnClick": function( nButton, oConfig, flash ) {
			this.fnSetText( flash, this.fnGetTableData(oConfig) );
		}
	} ),
	...
	"copy": $.extend( {}, TableTools.buttonBase, {
		...
		"sButtonText": "<i class='fa fa-copy'></i> 复制",
		"fnClick": function( nButton, oConfig, flash ) {
			this.fnSetText( flash, this.fnGetTableData(oConfig) );
		},
	...
	"pdf": $.extend( {}, TableTools.buttonBase, {
		...
		"sButtonText": "<i class='fa fa-file-pdf-o'></i> 生成PDF",
	...
	"print": $.extend( {}, TableTools.buttonBase, {
		"sInfo": "<h6>打印预览</h6><p>请使用您浏览器自带的打印功能 "+ "来打印该表格.退出该界面请按Esc.</p>",
		"sMessage": null,
		"bShowAll": true,
		"sToolTip": "打印预览",
